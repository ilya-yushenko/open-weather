...
import android.yushenko.openweather.ui.fragments.main.pager.recycler.DailyAdapter
import android.yushenko.openweather.ui.fragments.main.pager.recycler.HourlyAdapter
...
class WeatherFragment(private val search: Search) : Fragment(R.layout.weather_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        deleteClick.setOnClickListener {
            viewModel.deleteItemHistory(search)
        }
